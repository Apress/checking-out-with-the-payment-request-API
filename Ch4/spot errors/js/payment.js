window.onload = function(e) {
  ...
  function updateDetails(details, shippingOption, resolve, reject, stotal) {
    ...
    details.displayItems.splice(2, 1, selectedOption);
    resolve(details);
  }
  ...
  document.querySelector(".pay-button").addEventListener("click", function(e) {
    ...
    if (window.PaymentRequest) {
      ...
      const paymentOptions = { requestPayerEmail: true, requestShipping: true, shippingType: "pickup" };
	  ...
	  console.log("Country: " + request.shippingAddress.country);
        }));
      });
